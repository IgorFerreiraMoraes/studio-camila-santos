    ...
    <ion-page>
        ...
        <ion-content :fullscreen="true">
            ...
            <ion-list>
                ...
                <ion-item
                    v-else
                    v-for="appointment of user_appointments"
                >
                    <ion-label>
                        <span class="date">
                            {{
                    ...
                    <button
                        class="delete"
                        @click="
                            confirm_delete_appointment(appointment.id)
                        "
                    >
                        x
                    </button>
...
<script setup>
    ...
    const has_appointments = computed(
    ...
    function load_appointments() {
        ...
        const user_appointments_snap = onSnapshot(
            ...
            (snap) => {
                const updated_user_appointments = snap.docs.map(
                    (doc) => {
